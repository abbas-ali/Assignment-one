...
#plot 3
plot(mydata$posixDate,mydata$Sub_metering_1,type="l",xlab="",ylab="Energy sub metering")
lines(mydata$posixDate,mydata$Sub_metering_2,col="red")
lines(mydata$posixDate,mydata$Sub_metering_3,col="blue")
legend("topright", col=c("black","red","blue"), c("Sub_metering_1  ","Sub_metering_2  ", "Sub_metering_3  "),lty=c(1,1), lwd=c(1,1))

#plot 4
 par(mfrow=c(2,2))
 a<-plot(mydata$posixDate,mydata$Global_active_power,xlab="",type="l",ylab="Global Active Power(kilowatts)")
 b<-plot(mydata$posixDate,mydata$Voltage,xlab="",type="l",ylab="Voltage")
 c<-plot(mydata$posixDate,mydata$Sub_metering_1,type="l",xlab="",ylab="Energy sub metering")
 lines(mydata$posixDate,mydata$Sub_metering_2,col="red")
 lines(mydata$posixDate,mydata$Sub_metering_3,col="blue")
 legend("topright", col=c("black","red","blue"), c("Sub_metering_1  ","Sub_metering_2  ", "Sub_metering_3  "),lty=c(1,1), lwd=c(1,1))
 d<-plot(mydata$posixDate,mydata$Global_reactive_power,xlab="",type="l",ylab="Global_reactive_power")
